...
urlpatterns = [
    ...
    path('get_books_by_genre_name/<str:genre_name>', biblio_app.views.get_books_by_genre_name, name='get_books_by_genre_name'),     # http://127.0.0.1:8000/get_books_by_genre_name/сказка
